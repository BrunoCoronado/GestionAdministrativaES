...
{
    public partial class VerActividadesMatriculadas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (this.IsPostBack)
                    {
                        verActividad_click(Request.Form[hfName.UniqueID]);
                    }
                }
            }
            catch (Exception ex)
        ...
        protected void verActividad_click(string id)
        {
            Response.Redirect("VerActividad.aspx?reservacion=" + id + "", false);
        }
