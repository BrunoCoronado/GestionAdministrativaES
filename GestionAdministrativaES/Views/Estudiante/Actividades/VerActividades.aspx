<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerActividades.aspx.cs" Inherits="GestionAdministrativaES.Views.Estudiante.Actividades.VerActividades" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <%
     for (int i=0; i<(actividadesNuevas.Length/5);i++)
     {
         ...
         Response.Write("<button id=\" "+actividadesNuevas[i,5]+" \" class=\"btn btn-primary\" onclick=\"myFunction("+actividadesNuevas[i,5]+")\">Matricularse</button>");
         Response.Write("</div>");
         Response.Write("</div>");
         Response.Write("</div>");
     }
